...
function TileSwitch({ onPrev, onNext, numTiles, activeIndex, visible }: TileSwitchProps) {
    ...
    const progressPercent = numTiles > 1 ? (100 / (numTiles - 1)) * activeIndex : 0;
    ...
    return (
        ...
        >
            ...
            <div className="relative mx-4" style={{ width: progressBarWidth }}>
                ...
                />
                <div
                    className="absolute top-1/2 w-3 h-3 bg-primary shadow transition-transform duration-300"
                    style={{
                        transform: `translate(${indicatorX}px, -50%) rotate(45deg)`,
                    }}
                />
